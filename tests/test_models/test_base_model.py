...
class TestBaseModelInstantiation(unittest.TestCase):
    ...
    def test_created_at_is_public_datetime(self):
        """Test if created_at is a public datetime attribute."""
        self.assertEqual(datetime, type(BaseModel().created_at))

    def test_updated_at_is_public_datetime(self):
        """Test if updated_at is a public datetime attribute."""
        self.assertEqual(datetime, type(BaseModel().updated_at))

    def test_two_models_unique_ids(self):
        """Test if two models have unique ids."""
        bm1 = BaseModel()
        bm2 = BaseModel()
        self.assertNotEqual(bm1.id, bm2.id)

    def test_two_models_different_created_at(self):
        """Test if two models have different created_at values."""
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
    ...
    def test_two_models_different_updated_at(self):
        """Test if two models have different updated_at values."""
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
    ...
    def test_instantiation_with_None_kwargs(self):
        """Test instantiation with None as arguments."""
...
class TestBaseModelSave(unittest.TestCase):
    ...
    def test_one_save(self):
        """Test the save method with a single save."""
        bm = BaseModel()
        sleep(0.05)
